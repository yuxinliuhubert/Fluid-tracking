%% Data Input
function [kalman_position_velocity, r0_avg] = Phase1_pt_3d(true_position_3d, noise, delta_T, NOS,theta_degree, SRD, RDD)
format default
...
for i = 1:NOS-1
    r_now=T(r_now+v*delta_T*i,theta); % true location in the newly rotated axes, last location plus velocity*time
