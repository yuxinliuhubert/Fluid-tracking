function Phase4Graph(real_positions, estimated_positions, conditions,v,method,dataPiling,f2)
% close all
...
annotation('textbox', [0.74, 0.2, 0.3, 0.2], 'String', ...
    sprintf(['Min Distance: %0.2f\nMax Distance: %0.2f\n' ...
             ...
             'Method: %s\n' ...
             'Data Piling: %s'], ...
             min_val, max_val, NOS, theta_degree, delta_T,NOS_per_section,method,dataPiling), ...
    'FitBoxToText', 'on');
