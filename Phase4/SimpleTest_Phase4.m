SOD = 15; ODD = 400;NOS=30; noise =0; delta_T = 1/68; %detector operates at 68FPS
...
%add new particles
r_expression1=@(t) [2*sin(30*t+0.1),2*cos(30*t-0.3),10*t];
...
figure
plot3(real_positions1(:,1),real_positions1(:,2),real_positions1(:,3))
hold on
